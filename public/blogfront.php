				...
				<div class="cell-md-10">
					<div class="blog_summaries">
						<div class="post-container">
							<div class="wrapper">
								<div class="post_header">
									...
									<p class="author">By<a href="/about.php" target="_self"> <span>Paul Love</span></p></a>
								</div>
								<div class="post_body">
									<p>
									...
									<a href="/blog.php" target="_self"><p class="blog_img_note">14 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
						...
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">19 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">4 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">10 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
						...
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">134 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">34 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
							<div class="wrapper">
								...
								<div class="post_body">
									...
									<p>Google's Material Design is my favorite UI style for the moment. Read up on their design guide if you are not familiar with it. I added some ripple effects to my site! I have to give credit to Dominik Biedebach for the plug in.</p>
									<a href="/blog.php" target="_self"><p class="blog_img_note">7 comments</p></a>
								</div>
							</div>
						</div> <!-- post-container -->
						<div class="post-container">
						...
						<div class="post-container">
							<div class="wrapper">
								<div class="post_header">
									<h2 class="post_title">A Different Title</h2>
									<p class="author">By<a href="/about.php" target="_self"> <span>Paul Love</span></p></a>
								</div>
								<div class="post_body">
				...
				<div class="cell-xs-12 cell-md-2">
									<div class="row">
										...
										<div class=" cell-md-12">
											<ul class="cell-xs-12 cell-sm-12 cell-md-12 style-list">
												<li>Code</li>
												<li>Art</li>
												<li>My Dog</li>
												<li>Soccer</li>
