<div class="row footer no-gutters" data-role="footer">
	<div class="cell-md-12" >
			<ul id="footerOptions">
				<li class="cell-xs-6 cell-sm-4 cell-md-2"><a href="#">Contact Artist</a></li>
				<li class="cell-xs-6 cell-sm-4 cell-md-2"><a href="#">Newsletter</a></li>
